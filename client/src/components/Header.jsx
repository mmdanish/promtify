  ...
  return (
    <div className="flex flex-col justify-center items-center text-center my-20">
      ...
      <h1 className="text-4xl max-w-[300px] sm:text-7xl sm:max-w-[590px] mx-auto mt-10 text-center">
         Words into <span className="text-blue-600">visuals</span>, in a flash.
      </h1>
      ...
      <div className="flex flex-wrap justify-center mt-16 gap-3">
        {Array(6)
          ...
          .map((item, index) => (
            <img
              className="rounded hover:scale-105 transition-all duration-300 cursor-pointer max-sim:w-10"
      ...
      <p className="mt-2 text-neutral-600">Generated images from promtify</p>
    </div>
  );
};
